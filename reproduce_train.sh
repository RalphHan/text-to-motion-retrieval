...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE HYDRA_FULL_ERROR=1 python train.py -m ++optim.seed="$REPS" motion_model="$MOTION_MODELS" text_model="$TEXT_MODELS" optim="$LOSSES" data="$DATASETS"
